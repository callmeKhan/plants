...
function PlatformsPageInner() {
  ...
  const [highlightPlantId, setHighlightPlantId] = useState<string | null>(searchParams.get("highlight"));
                      ...
                      <div className="space-y-2">
                        {platformLocs.map((loc) => {
                          ...
                          return (
                            <div
                              key={loc.id}
                              className={`rounded-xl px-3 py-2.5 space-y-2 transition-all duration-500 ${loc.id === highlightPlantId
